...
const unwrapElements = ($, onIssue) => {
    const unwrapIfNeccessary = ($e) => {
        ...
        const hasUnncessaryDivWithClass = ["primary-txt", "article-txt", "product-content", "product-landing-content", "bank-prod-page", "product-description", "container", "ct-img-web-banner", "bank-name"].some((cn) => $e.hasClass(cn));
